...
urlpatterns = [
    ...
    path("tasks/<id>/request-complete/", TaskCompleteRequestView.as_view(), name="task-request-complete"),

    path("tasks/<int:id>/approve-or-reject/", TaskApproveOrRejectView.as_view(), name="task-approve-reject"),
